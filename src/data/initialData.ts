...
export const INITIAL_STUDENTS: Student[] = [
  {
    ...
    grade: 'F.Sc Part 1 (Pre-Engineering)',
  ...
  },
  {
    ...
    grade: 'O Level (Cambridge IGCSE)',
    board: 'Cambridge Assessment International (CAIE)',
    tuitionMode: 'online',
  ...
  },
  {
    ...
    grade: 'Class 10 (Matric)',
    board: 'Punjab Board (BISE Lahore)',
    tuitionMode: 'home',
  ...
  },
  {
    ...
    grade: 'A Level (Cambridge)',
    board: 'Cambridge (CAIE A2)',
    tuitionMode: 'online',
